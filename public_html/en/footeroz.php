<div id="footer">
      <div class="container">
          <div class="logo"><img src="bilder/TH_Koeln_Logo.svg"><span class="impressum"><a href="impressum.php">Imprint</a></span></div>
...
<?php
if( isset($tt) ) {
	echo '<div id="tt-text-no" style="display:none;">No more tips.</div>';
