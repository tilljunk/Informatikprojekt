...
<title>Combinatorics e-learning</title>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				<?php
				if($_SERVER['PHP_SELF'] == "/en/basiswissen.php")
					echo '<li class="active"><a href="basiswissen.php">Basic knowledge</a></li>';
				else echo '<li><a href="basiswissen.php">Basic knowledge</a></li>';
				if($_SERVER['PHP_SELF'] == "/en/lernmodus.php")
					echo '<li class="active"><a href="lernmodus.php">Learning mode</a></li>';
				else echo '<li><a href="lernmodus.php">Learning mode</a></li>';
				if($_SERVER['PHP_SELF'] == "/en/pruefungsmodus.php")
					echo '<li class="active"><a href="pruefungsmodus.php">Exam mode</a></li>';
				else echo '<li><a href="pruefungsmodus.php">Exam mode</a></li>';
				?>
