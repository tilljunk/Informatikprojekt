...
<script>
    ...
    <div class="jumbotron" id="lernmodusfrage">
      <div class="container">
		<div id="inner">
        <h2>Learning mode > Permutation</h2>
  ...
  <?php include("includes/collapse_formelsammlung.php"); ?>
    ...
    <div id="collapsePermutation" class="panel-collapse collapse">
      <div class="panel-body">
       ...
       In a treasure hunt game all 5 stations have to be reached. The set of stations n is 5, thus k is 5 as well, since all stations have to be reached.</div>
    </div>
  </div>
</div>
