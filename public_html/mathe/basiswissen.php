      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="basiswissen.php">Basiswissen</a></li>
            <li><a href="lernmodus.php">Lernmodus</a></li>
...
<div class="panel-group" id="accordion">
    ...
    <div id="collapsevari" class="panel-collapse collapse">
      <div class="panel-body">
       Bei der Variation werden k Elemente aus einer n-elementigen Menge gezogen. Die Reihenfolge ist dabei wichtig.<br/><br/>
       <strong>Erklärung</strong><br />
       <strong>n:</strong> Anzahl der Objekte in Urne<br />
       <strong>k:</strong> Anzahl der Ziehungen<br />
       <br />
  ...
  <div class="panel panel-default">
    ...
    <div id="collapsekomb" class="panel-collapse collapse">
      <div class="panel-body">
       Bei der Kombination werden k Elemente aus einer n-elementigen Menge gezogen. Die Reihenfolge spielt keine Rolle.
       <br/><br/>
       <strong>Erklärung</strong><br />
       <strong>n:</strong> Anzahl der Objekte in Urne<br />
       <strong>k:</strong> Anzahl der Ziehungen<br />
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseFour" class="panel-collapse collapse">
      <div class="panel-body">
        Für n, k ∈ <img src="bilder/natuerlichezahl.png"> mit k ≤ n definiert man:<br/>
